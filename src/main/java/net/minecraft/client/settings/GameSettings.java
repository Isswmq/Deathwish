...
public class GameSettings
{
    ...
    public KeyBinding TEST_MODULE = new KeyBinding("HUD Possible", Keyboard.KEY_Y, "Deathwish");
    ...
    public void addClientBinds(){
        this.keyBindings = ((KeyBinding[]) ArrayUtils.add(this.keyBindings, this.TEST_MODULE));
    }
