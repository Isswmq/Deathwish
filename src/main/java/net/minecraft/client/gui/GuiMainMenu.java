...
public class GuiMainMenu extends GuiScreen
{
    ...
    private static FontRenderer renderer = new FontRenderer("font2", 20, Font.PLAIN, true, true);
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 67, j + 72 - 24, 135, 20, I18n.format("menu.options")));
        this.buttonList.add(new GuiButton(4, this.width / 2 - 67, j + 72 + 24, 135, 20, I18n.format("menu.quit")));
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        this.buttonList.add(new GuiButton(1, this.width / 2 - 67, j + 72 - 72, 135, 20, I18n.format("menu.singleplayer")));
        this.buttonList.add(new GuiButton(2, this.width / 2 - 67, j + 72 - 48,135, 20, I18n.format("menu.multiplayer")));
        ...
        {
            this.realmsButton = this.addButton(new GuiButton(14, this.width / 2 - 67, j + 72, 135, 20, I18n.format("Alt Manager")));
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        GL11.glColor4f(1,1,mouseX, partialTicks);
        GlStateManager.disableAlpha();
        GlStateManager.enableAlpha();
        this.mc.getTextureManager().bindTexture(new ResourceLocation("deathwish/background2.jpg"));
        ...
        //FontUtils.normal.drawString("Deathwish", 100,50, new Color(0xDE3E7E).getRGB());
        //FontRenderer fr = new FontRenderer("font3", 45, Font.PLAIN, true, true);
        //fr.drawCenteredString("Deathwish", 240, 70, new Color(0xFFFFFF, false).getRGB());
